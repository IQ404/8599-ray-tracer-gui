/*****************************************************************//**
 * \file   WhittedRenderer.cpp
 * \brief  The specific implementation for rendering Whitted-style ray-traced scenes
 * 
 * \author Xiaoyang Liu
 * \date   June 2023
 *********************************************************************/
...
namespace Whitted
{
	...
	glm::vec3 mirror_reflection_direction(const glm::vec3& incident_ray_direction, const glm::vec3& surface_normal)
	{
	...
	float accurate_fresnel_reflectance(const glm::vec3& incident_ray_direction, const glm::vec3& surface_normal, const float& entity_refraction_index)
	...
	std::optional<Whitted::Payload> get_intersection_payload(
