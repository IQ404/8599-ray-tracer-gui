...
- To run from the source code, we need:
  ...
  Then, execute `scripts/Setup.bat` after <ins>recursively</ins> clone the repository, this will generate the Visual Studio 2022 solution for us.
...
- A step towards "non-physically photorealistic rendering" (kidding...)
